...
def actionauthor():
    messagebox.showinfo("Author", "Ahmad Horyzat\nCollage: CSE\PPU")
...
def actionPlus():
    ...
    if(is_number(num1) == True and is_number(num2) == True and num1 != ' ' and num2 != ' '):
        ...
        messagebox.showerror("Error", " Invalid entery")
...
Numberentry1.place(relx=0.5, rely=0.3, anchor='center', width= 220, height= 25)
Numberentry2.place(relx=0.5, rely=0.4, anchor='center', width= 220, height= 25)

plusbutton = Button(root, text="+", bg='#efaf1a', width = 5, height= 2, command = actionPlus);
plusbutton.place(relx=0.12, rely=0.7)

minusbutton = Button(root, text="-", bg='#efaf1a', width = 5, height= 2, command = actionMinus);
minusbutton.place(relx=0.32, rely=0.7)

mulbutton = Button(root, text="*", bg='#efaf1a', width = 5, height= 2, command = actionMul);
mulbutton.place(relx=0.52, rely=0.7)

divbutton = Button(root, text="/", bg='#efaf1a', width = 5, height= 2, command = actionDiv);
divbutton.place(relx=0.72, rely=0.7)
